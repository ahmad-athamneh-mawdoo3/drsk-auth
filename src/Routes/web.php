...
|
*/
Route::get('test.auth', 'mawdoo3\drsk\auth\Controllers\SearchController@testRoute')->name('asasdasad');
Route::prefix('search')->namespace('mawdoo3\drsk\auth\Controllers')->group(function () {
